            ...
            <div class="col-md-12">
                <form method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8"><input type="member" value="<?php echo $data['tahun_terbit']; ?>"class="form-control" name="tahun_terbit"></div>
                    </div> 
                    <div class="row mb-3">
                        <div class="col-md-2">Deskripsi</div>
                        <div class="col-md-8">
                            <textarea name="deskripsi" rows="5" class="form-control"><?php echo $data['tahun_terbit']; ?></textarea>
                        </div>
                    </div> 
                    <div class="row">
